...
p2 <- ggplot(data, aes(x = year, y = interest_rate)) +
  ...
  ggtitle("Broad Y-Axis")

# Arrange plots side by side
grid.arrange(p1, p2, ncol = 2)
```

Imagine looking at them quickly, the way you might while skimming a news article:
...
you can get help from the R console:
...
The domains `r-project.org` and `tidyverse.org` should be the first places you check.
...
4. Enter the data that you created into a new `.Rmd` file following the example below:
