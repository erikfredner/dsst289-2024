...
format. Here is an example of a tabular data set of food types, which
...
4. Once you have finished reading and completing the items above, make sure to submit the survey.