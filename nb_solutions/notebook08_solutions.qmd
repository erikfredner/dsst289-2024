...
the estimated lifetime earnings of these three majors? **Answer**:
...
the rows of the data corresponding to the 50th percentile of earnings (i.e., average earnings *within* a major). Draw a
...
percentile `"navy"`. Order the majors based on earnings.
